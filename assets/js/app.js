//Array  Of words 
const easyWords=[
    "able","ago","add","bay","bill","bat","cat","chat","catch","deal","disk","ear","fall","food","gun","hold","ice","inch","king","level","mark","need","now","pen","range","salt","test","very","world","zero" 
] 
const normalWords=[
...
function getWord(){
    //Get Word From  Array
    let randomWord =defaultlistWordes[Math.floor(Math.random()* defaultlistWordes.length)];
    //Get Word Index
...
function  showPercent(){
    let getpercent=Math.floor((scoreGot.innerHTML/defaultlistWordes.length)*(100));
    let counter=0
    setInterval(()=>{
